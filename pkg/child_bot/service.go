...
- Стратегия. Если указано *1* — бот применяет правила только на первое сообщение, далее не вмешивается в вашу переписку с отправителем. Если указано *2* — бот применяет правила автоответа и на первое сообщение отправителя, и на дальнейшие;
